...
export function Particles({
  ...
  useFrame((state, delta) => {
    ...
    // Light mode: slate-400 (#94a3b8) - subtle gray particles
    // Dark mode: slate-300 (#cbd5e1) - lighter particles for contrast
    const color = isDark
      ? new THREE.Color(0.796, 0.835, 0.882) // #cbd5e1 slate-300
      : new THREE.Color(0.580, 0.639, 0.722); // #94a3b8 slate-400
    dofPointsMaterial.uniforms.uColor.value = color;
